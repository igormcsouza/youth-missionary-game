...
class TestDashboardTargetTasks:
    ...
    def test_target_tasks_mapping_structure(self):
        ...
        with (
            patch("Dashboard.CompiledFormDataRepository.get_all") as mock_compiled,
...
class TestDashboardDataProcessing:
    ...
    def test_calculate_task_totals_with_realistic_data(self):
        ...
        with (
            ...
            mock_tasks.return_value = [
                MagicMock(
                    id=1, tasks="Entregar Livro de Mórmon + foto + relato no grupo"
                ),
                ...
                MagicMock(
                    id=5, tasks="Postar mensagem do evangelho nas redes sociais + print"
                ),
...
class TestDashboardNewFeatures:
    ...
    def test_activities_contain_correct_metrics_only(self):
        ...
        # Count the number of activity tuples by counting lines that start tuples
        # Look for either '        (' or '        ("...' patterns
        opening_paren_pattern = r'^\s+\('
        tuple_matches = re.findall(opening_paren_pattern, activities_section, re.MULTILINE)
    ...
    def test_calculate_weekly_youth_points_function(self):
        ...
        with (
            ...
            mock_compiled.return_value = [
                ...
                MagicMock(
                    youth_id=1, task_id=1, quantity=3, bonus=0, timestamp=old_timestamp
                ),  # Old entry
            ]
    ...
    def test_leaderboard_top_5_limit(self):
        ...
        with (
            ...
            for i in range(1, 8):
                youth = MagicMock(
                    id=i, name=f"Youth{i}", organization="Rapazes", total_points=100 - i
                )
...
class TestDashboardUILayoutImprovements:
    ...
    def test_top_5_empty_state_unchanged(self):
        ...
        with (
            ...
            assert any(
                "Nenhum jovem cadastrado ainda." in info for info in info_elements
            )
    ...
    def test_top_5_no_weekly_activity_state(self):
        ...
        with (
            ...
            mock_youth.return_value = [
                MagicMock(
                    id=1, name="João Silva", organization="Rapazes", total_points=100
                ),
                MagicMock(
                    id=2, name="Maria Santos", organization="Moças", total_points=80
                ),
            ]
            mock_tasks.return_value = []
    ...
    def test_top_5_position_indicators_preserved(self):
        ...
        with (
            ...
            mock_youth.return_value = [
                MagicMock(
                    id=1, name="Ana Costa", organization="Moças", total_points=50
